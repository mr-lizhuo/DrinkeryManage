...
public class TipWizardFrame extends JFrame {
	...
	public TipWizardFrame(final Vector user) {
		...
		super();
		String Namess = user.get(1).toString();
		
		System.out.print(Namess);
		...
		splitPane.setDividerLocation(2000);// 设置面版默认的分割位置
		...
		label1.setPreferredSize(new Dimension(1000, 180));
		URL rmbUrl1 = this.getClass().getResource("/img/bottom.jpg");
		ImageIcon rmbIcon1 = new ImageIcon(rmbUrl1);
		label1.setIcon(rmbIcon1);
		final GridBagConstraints gridBagConstraints_19 = new GridBagConstraints();
		gridBagConstraints_19.insets = new Insets(0, -100, 0, 15);
		gridBagConstraints_19.gridheight = 4;
		gridBagConstraints_19.gridy = 0;
		gridBagConstraints_19.gridx = 0;
		checkOutPanel.add(label1, gridBagConstraints_19);
		...
		gridBagConstraints_9.insets = new Insets(0, 1000, 0, 15);
