...
public class UpdatePasswordDialog extends JDialog {
	...
	public UpdatePasswordDialog() {
		...
		try{
				...
				String oldPassword = MD5.EncoderByMd5(turnCharsToString(oldPasswords));
				char[] newPasswords = newPasswordField.getPassword();
				String newPassword = MD5.EncoderByMd5(turnCharsToString(newPasswords));
				char[] repeatPasswords = repeatPasswordField.getPassword();
				String repeatPassword =  MD5.EncoderByMd5(turnCharsToString(repeatPasswords));
